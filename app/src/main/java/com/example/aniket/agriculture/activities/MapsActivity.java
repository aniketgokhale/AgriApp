...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
        ...
        /*selectPlace.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    // mMap.addMarker(new MarkerOptions().position(mDefaultLocation).title("PICT").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_ORANGE)));
                    // mMap.moveCamera(CameraUpdateFactory.newLatLng(mDefaultLocation));
                } catch (Exception e) {
                    e.printStackTrace();
                }

                searchMarket("Spinach");
            }
        });*/
    ...
    private void searchMarket(String selectedCrop) {
        ...
        String[] districts = md.getDistrict().split(",");
